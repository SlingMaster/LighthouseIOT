...
#define IOT_TYPE                (4U)                        // введено поняття типу пристрою, потрібно для сумісності з прогамним забезпеченням 
//                                                          | 0 • оригінальна лампа | 1 • лампа javelin | 2 • робот | 3 • рорбот 007 | 4 • IOT lighthouse |
// ROBOT -------------------------------
#define USE_IOT
#ifdef USE_IOT

#define TOWER_LIGHT_PIN         (4U)                        // tower light                    • (D2) ( 4U)                                                                            //   GPIO
#define MB_LED_PIN              (2U)                        // blue led на платі              • (D4) ( 2U)

#endif

// --- DF PLayer -----------------------
/* Lighthouse DF PLayer configuretion */
...
#ifdef MP3_TX_PIN
#define MP3_PLAYER                                          // може використовуватись в якості MP3 програвача 
...
#define LED_PIN                  (0U)                        // пін управління матриці або стрічки      (D3)
#define MATRIX_TYPE              (0U)                        // тип матриці: 0 - зигзаг, 1 - параллельна

/* robot VII */
// #define WIDTH                   (11U)                       // ширина матриці
// #define HEIGHT                   (2U)                       // висота матриці
...
#ifdef USE_IOT
#define NUM_LEDS                (uint16_t)(WIDTH * HEIGHT) + 10
#else
