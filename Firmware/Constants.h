...
static const uint8_t defaultSettings[][4] PROGMEM = {
  ...
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Штиль на морі","v":[100,255,1,100,0]},  Calm on the sea
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Дощ на морі","v":[100,255,1,100,0]}, Rain on the sea
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Шторм на морі","v":[100,255,1,100,0]}, Storm on the sea
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Шторм з грозою","v":[100,255,1,100,0]}, Storm with thunder
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Туман в Одесі","v":[100,255,1,100,0]}, Fog in Odessa

  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Ранній ранок","v":[100,255,1,100,0]}, Early morning
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Сієста","v":[100,255,1,100,0]}, Siesta
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Тихий вечір","v":[100,255,1,100,0]}, Quiet evening

  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Вечірня вахта","v":[100,255,1,100,0]}, Evening watch
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Нічна вахта","v":[100,255,1,100,0]}, Night watch
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Зміна з вахти","v":[100,255,1,100,0]}, Change of watch

  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Ностальгуючий Доглядач","v":[100,255,1,100,0]}, NostalgicCaretaker
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Доглядач на підпитку","v":[100,255,1,100,0]}, Keeper on a tip
  {  LED_BR, 200,  50, SOFT_DELAY}, // {"n":"Занедбаний маяк","v":[100,255,1,100,0]}, Abandoned Lighthouse
  {  LED_BR, 200,  50, SOFT_DELAY}  // {"n":"Real Time","v":[100,255,1,100,0]}, Real Time
...
//#define EFF_MATRIX            (0) (MODE_AMOUNT - 6)            // Maтpицa
//#else
//#define EFF_MATRIX             (MODE_AMOUNT - 5)            // Maтpицa
//#endif

#define EFF_MATRIX            (0)
#define EFF_WHITE_COLOR       (0) //  (EFF_MATRIX + 2)             // Бeлый cвeт
...
#define BUTTON_CLICK_TIMEOUT  (600U)                        // def 500U | максимальное время между нажатиями кнопки в мс, до достижения которого считается серия последовательных нажатий
...
// --- РАССВЕТ -------------------------
#ifdef USE_IOT
#define DAWN_BRIGHT           (150U)                        // максимальная яркость рассвета (0-255)
#else
...
#define CMD_MP3_VOLUME        (70U)
#define CMD_MP3_PREV          (71U)
#define CMD_MP3_STOP          (72U)
#define CMD_MP3_PLAY          (73U)
#define CMD_MP3_NEXT          (74U)
...
// -------------------------------------
String VERSION = "6.0 " + String(MODE_AMOUNT);
